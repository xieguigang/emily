Namespace gromacs
    ...
    ''' <summary>
    ''' GROMACS (GROningen MAchine for Chemical Simulations) is a widely-used molecular dynamics simulation package. 
    ''' In GROMACS, the `.rtp` (Residue Topology) file is an essential component used to define the topology of 
    ''' residues for the purpose of molecular dynamics simulations. Here's an overview of what the `.rtp` file 
    ...
    ''' ```
    ''' 
    ''' In this example, the `ALA` residue is defined with its atoms, bonds, angles, and dihedrals. The atom types 
    ''' (e.g., NH1, CT1, C, O, CT3) correspond to specific parameters in the force field.
    ''' 
    ''' The `.rtp` file is a crucial part of the GROMACS topology files and must be carefully prepared to ensure 
