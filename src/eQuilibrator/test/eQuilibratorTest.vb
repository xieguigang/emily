...
Module eQuilibratorTest
    ...
    Private Sub RunSelfChecks(cache As CompoundCache, cc As ComponentContribution, formula As String)
        ...
        If atp IsNot Nothing Then
            ...
            Check("组件贡献法存在 pH 依赖 (pH7 ≠ pH8)", cc7.HasValue AndAlso cc8.HasValue AndAlso Math.Abs(cc7.Value - cc8.Value) > 0.000001)
            ...
            Check("组贡献法存在 pH 依赖 (pH7 ≠ pH8)", gc7.HasValue AndAlso gc8.HasValue AndAlso Math.Abs(gc7.Value - gc8.Value) > 0.000001)
        End If
